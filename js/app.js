...
for (var j = 1; j <= 6; j++) {
  ...
  if (CheckInsidArray(UserCarInput)) {    //Check The Condition By Calling CheckInsidArray To Know If The User Insert The Correct answer that be in array
    score++;
    alert('You got it *-^ \n The Correct Answer \n 1- ' + Cars[0] + ' \n 2-' + Cars[1] + ' \n 3- ' + Cars[2] + ' \n 4- ' + Cars[3] + '\n 5- ' + Cars[4] + '\n 6-' + Cars[5]);
    break;
  }
...
function CheckInsidArray(answer) {
